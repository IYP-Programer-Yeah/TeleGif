...
public class SecondFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (view==null) {
            ...
            ImageView imageView = (ImageView) view.findViewById(R.id.SecondImg);
            ...
            if (width > height) {
                Img = 1;
                imageView.setImageResource(R.drawable.viewpager2h);
            } else {
                Img = 0;
                imageView.setImageResource(R.drawable.viewpager2);
            }
